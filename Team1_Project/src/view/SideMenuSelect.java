...
public class SideMenuSelect extends SauceSelect {
	...
	public JLabel sideMenuNameLb[] = new JLabel[6]; // 메인 메뉴 이름 라벨
	public JLabel sideMenuPriceLb[] = new JLabel[6]; // 메인 메뉴 가격 라벨
	...
	SideMenu[] sideMenuArr = new  SideMenu[6]; // 메인 메뉴 객체 배열
	public SideMenuSelect() {
		...
		SauceTop.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		...
		sideMenuTop.setFont(new Font("맑은 고딕", Font.BOLD, 16));
		...
		for(int i=2;i<orderList.size();i++) {
			if(orderList.get(i) instanceof Topping) {
				...
				toppingNameLb[0].setFont(new Font("맑은 고딕", Font.BOLD, 14));
				toppingNameLb[0].setBounds(707, y1, 145, 15);
				toppingPriceLb[0].setFont(new Font("맑은 고딕", Font.BOLD, 14));
...
//			sauceNameLb[0].setFont(new Font("맑은 고딕", Font.BOLD, 14));
//			sauceNameLb[0].setBounds(707, y, 145, 15);
//			saucePriceLb[0].setFont(new Font("맑은 고딕", Font.BOLD, 14));
				...
				public void actionPerformed(ActionEvent e){
					...
					if((JButton)obj == selectButton[num]) 
					{
						...
						if(Side_count <  4 ) {
							...
							sideMenuNameLb[num].setFont(new Font("맑은 고딕", Font.BOLD, 14));
							sideMenuPriceLb[num].setFont(new Font("맑은 고딕", Font.BOLD, 14));
...
//				               priceSumLb.setText(Integer.toString(priceSum));
							...
							JOptionPane.showMessageDialog(null, "사이드 메뉴는 3가지 이상 선택하실 수 없습니다 .");
							Side_count--;
						}
					}
				}
		      ...
		      public void actionPerformed(ActionEvent e){
		    	 //JOptionPane.showMessageDialog(null, "사이드 메뉴는 3가지 이상 선택하실 수 없습니다 .");
		    	  if(Side_count > 0) {
		    		  ...
		    		  JOptionPane.showMessageDialog(null, "사이드 메뉴를 선택해주세요.");
		    	  }
