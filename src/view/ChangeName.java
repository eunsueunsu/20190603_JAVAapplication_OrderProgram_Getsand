...
public class ChangeName extends JFrame  {
	...
	public void ChangeNameLayOut() {    
		...
		JLabel changeName = new JLabel("닉네임");
		changeName.setForeground (new Color(255, 153, 0));
		changeName.setFont(new Font("맑은 고딕", Font.BOLD, 20));
		...
		check_bt.addActionListener(new ActionListener(){ //확인 누르면 마이페이지를 껐다가 켜기
		...
		cancel_bt.addActionListener(new ActionListener(){ //캔슬
			public void actionPerformed(ActionEvent e){  
